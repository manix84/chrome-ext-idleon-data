...
const charSubclassMap: StringMap = {
    ...
    "Infinilyte": "Virtuoso",
    "Barbarian": "Warrior",
    "Blood Berserker": "Barbarian",
    "Death Bringer": "Barbarian",
    "Squire": "Warrior",
    "Divine Knight": "Squire",
    "Royal Guardian": "Squire",
    "Bowman": "Archer",
    "Siege Breaker": "Bowman",
    "Mayheim": "Bowman",
    "Hunter": "Archer",
    "Beast Master": "Hunter",
    "Wind Walker": "Hunter",
    "Shaman": "Mage",
    "Bubonic Conjuror": "Shaman",
    "Spiritual Monk": "Shaman",
    "Wizard": "Mage",
    "Elemental Sorcerer": "Wizard",
    "Arcane Cultist": "Wizard"
};
...
const cardSetMap: StringMap = {
    ...
    "{%_All_Food_Effect": "Yum_Yum_Desert",
    ...
    "{%_Crit_Chance": "Hyperion_Nebula",
    "{%_Fight_AFK_Gain_Rate": "Smolderin'_Plateau",
    "{%_Multikill_Per_Tier": "Spirited_Valley",
    "{%_Class_Exp_(Multi)": "Shimmerfin_Deep",
    "{%_more_Dungeon_Credits": "Dungeons",
    "{%_Dmg,_Drop,_and_EXP": "Bosses",
    "{%_Drop_Rate": "Event"
};
